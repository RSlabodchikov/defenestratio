...
### 2.2. Характеристики пользователя <a name="2.3"></a>
...
*Только зарегистрированнвй пользователь может сбросить свой текущий результат.*

| Функция | Требования | 
|:---|:---|
| Сброс результата| Пользователь сбрасывает текущий личный результат, игра начинается заново.|
...
| Функция | Требования | 
|:---|:---|
| Создание пользовательских челленджей| Пользовате имеет возможность создать свой челлендж после прохождения челленджей, которые предлагаются в приложении.|
...
| Функция | Требования | 
|:---|:---|
| Удаление аккаунта| Пользовате может удалить аккаунт с возможностью его восстановления.|
